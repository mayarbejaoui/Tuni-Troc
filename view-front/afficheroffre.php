...
<body>
    ...
    <div class="col-md-4 col-lg-4 col-xl-4">
                    <div class="contact-info-left">
                        <h2><?php echo $offre['id_offre']; ?></h2>
                        <p><?php echo $offre['nom_offre']; ?> </p>
                        <ul>
                            <li>
                                <p><i class="fas fa-phone-square"></i><?php echo $offre['date_offre']; ?> </p>
                            </li>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i><?php echo $offre['type']; ?> </p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i> <a href=""><?php echo $offre['id_user1']; ?></a></p>
                            </li>
                            <li>
                                <p><i class="fas fa-envelope"></i><a href=""><?php echo $offre['id_user2']; ?></a></p>
                            </li>
