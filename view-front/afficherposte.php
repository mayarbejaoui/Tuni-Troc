    ...
    <?php
			...
			?>
             ...
             <div class="blog-img">
                ...
                $comm=$CommentC->recuperercomment($Comment['id_comment']);
                ?>
                <div class="col-md-3 col-lg-3 col-xl-3">
                <div class="blog-box">
                <div class="title-blog">
                                <h3><?php echo $comm['message']; ?></h3>
                                <img class="img-fluid"  src="images/<?php echo $comm['photo']; ?>" alt="" />

                                <p><?php echo $comm['date_comment']; ?></p>
                                <li><a href="likecomment.php?id_comment=<?php echo $comm['id_comment']; ?>"><i class="far fa-heart"></i><?php echo $comm['nb_likes']; ?></a></li>
                            </div>
                            </div>
             </div>
                <?php
