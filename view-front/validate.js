...
function validateFormrec() {
  ...
  let a = document.forms["myform"]["nom_perso"].value;
  let b = document.forms["myform"]["prenom_perso"].value;
  let c = document.forms["myform"]["email"].value;

  let d = document.forms["myform"]["num_tel"].value;
  let e = document.forms["myform"]["message"].value;
  ...
  if (b == "") {
    ...
    if (d == "") {
      alert("numero  must be filled out");
      return false;
    }
    if (e == "") {
  ...
  function validateFormposte() {
 
 
    let b = document.forms["myform"]["message"].value;
    let c = document.forms["myform"]["photo"].value;
